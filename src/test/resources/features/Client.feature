...
Funcionalidade: Criar Cliente na base de Dados
  ...
  Cenario: : 02 - Criação de cliente na base sem sucesso
  ...
  Cenario: : 04 - Atualizar cliente na base com sucesso
    Dado o cliente de CPF 49174699881 e nome "Nicole Tavares"
    E alterar os dados para CPF 49174699882 e nome Fernanda
    Quando for realizada a chamada no endpoint de atualizacao de cliente com cliente nao cadastrado
    Entao o cliente nao deve ser cadastrado e a requisicao será sem sucesso


  Cenario: : 05 - Delecao de cliente na base com sucesso
